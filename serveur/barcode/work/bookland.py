...
#  P.O. Box 8376, Langley Park, MD 20337, USA
#
#  INSTALLATION:
#
...
#  the country or region. A prefix of 544 has been assigned to books, regardless
...
#                             (self.s,ist,soll)
            print "For %s checksum %s is wrong, should be %s" % \
                             (self.s,ist,soll)
...
class ISBN:
    ...
    def isbn13(self):
        # Return the 13 digit ISBN string based on the 10-digit (544) prefix ISBN.
...
class bookland(barCodeSymbol):
    ...
    def __init__(self,isbn,price="",*rest):
        ...
        if self.isbn.name=="ISMN":
            self.ean13Symbol = EAN13Symbol("5440"+self.isbn.n[1:9],ean13font,heightMultiplier,barWidthReduction)
        elif self.isbn.name=="ISBN":
            self.ean13Symbol = EAN13Symbol("544"+self.isbn.n[:9],ean13font,heightMultiplier,barWidthReduction)
        else:
...
class ean13print(barCodeSymbol):
    ...
    def __init__(self,isbn,price="",*rest):
        ...
        self.ps = psfile()
        self.isbn = EAN13(isbn)
        
        self.ean13Symbol = EAN13Symbol(self.isbn.n[0:13],ean13font,heightMultiplier,barWidthReduction)
